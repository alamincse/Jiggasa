<?php /* Smarty version Smarty-3.1.16, created on 2014-12-07 16:12:59
         compiled from "C:\xampp\htdocs\myphpsite\CMS_PROJECT\template\fontend\search.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2244154846e7bbf04a2-00265156%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd7a504db8726f10d082dcaec2c0b43411f75cd1a' => 
    array (
      0 => 'C:\\xampp\\htdocs\\myphpsite\\CMS_PROJECT\\template\\fontend\\search.tpl',
      1 => 1417726787,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2244154846e7bbf04a2-00265156',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54846e7bd1ca01_57721610',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54846e7bd1ca01_57721610')) {function content_54846e7bd1ca01_57721610($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\xampp\\htdocs\\myphpsite\\CMS_PROJECT\\include\\smarty\\libs\\plugins\\modifier.escape.php';
...
?><div class="content shadow">
	<div class="row">
		<div class="main-page span8">
			<h2 class="page-header about-header">Search Page</h2>
			<?php if (isset($_smarty_tpl->tpl_vars['data_search']->value)) {?>
				<?php if ($_smarty_tpl->tpl_vars['data_search']->value!=0) {?>
					
					<h2 class="about-header">Search&nbsp;&raquo;&nbsp;<a href="" style="font-size:16px;"><?php echo $_smarty_tpl->tpl_vars['data_search']->value['keyword'];?>
</a></h2>
...
?>
							<header>
								<h2 class="page-header empty-title"><a href="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
...
"><?php echo $_smarty_tpl->tpl_vars['data']->value['post_title'];?>
								...
								<p class="post-author empty-author">
									<a href="<?php echo $_smarty_tpl->tpl_vars['data']->value['post_id'];?>
">
