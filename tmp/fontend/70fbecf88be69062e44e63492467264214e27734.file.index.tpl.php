<?php /* Smarty version Smarty-3.1.16, created on 2016-11-30 12:23:56
         compiled from "E:\xampp\htdocs\my_task\Jiggasa\template\fontend\index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20486583eaaea6fdb68-18944615%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '70fbecf88be69062e44e63492467264214e27734' => 
    array (
      0 => 'E:\\xampp\\htdocs\\my_task\\Jiggasa\\template\\fontend\\index.tpl',
      1 => 1480505035,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20486583eaaea6fdb68-18944615',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_583eaaea8f9623_99965697',
  'variables' => 
  array (
    'register' => 0,
    'u_name' => 0,
...
<?php if ($_valid && !is_callable('content_583eaaea8f9623_99965697')) {function content_583eaaea8f9623_99965697($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_image')) include 'E:\\xampp\\htdocs\\my_task\\Jiggasa\\include\\smarty\\libs\\plugins\\function.html_image.php';
if (!is_callable('smarty_modifier_date_format')) include 'E:\\xampp\\htdocs\\my_task\\Jiggasa\\include\\smarty\\libs\\plugins\\modifier.date_format.php';
if (!is_callable('smarty_modifier_replace')) include 'E:\\xampp\\htdocs\\my_task\\Jiggasa\\include\\smarty\\libs\\plugins\\modifier.replace.php';
if (!is_callable('smarty_modifier_capitalize')) include 'E:\\xampp\\htdocs\\my_task\\Jiggasa\\include\\smarty\\libs\\plugins\\modifier.capitalize.php';
...
&nbsp;
				...
				<?php if ($_smarty_tpl->tpl_vars['profile']->value==''&&$_smarty_tpl->tpl_vars['show_o_profile']->value=='') {?>
					<form action="" method="post" class="form-horizontal" style="margin-top:20px;">
						<input type="text" name="text-post" placeholder="Ask your question..." class="span5"  onfocus="if(this.placeholder=='Ask your question...'){this.placeholder=''}" onblur="if(this.placeholder==''){this.placeholder='Ask your question...'}"  required>
...
"><?php echo smarty_function_html_image(array('file'=>"subscribers/".((string)$_smarty_tpl->tpl_vars['info']->value['userId'])."/".((string)$_smarty_tpl->tpl_vars['info']->value['profile_img'])),$_smarty_tpl);?>
									...
									<form action="" method="post">
										<input type="text" name="give-ans" placeholder="Give your ans..." class="span4"  onfocus="if(this.placeholder=='Give your ans...'){this.placeholder=''}" onblur="if(this.placeholder==''){this.placeholder='Give your ans...'}"  required>
