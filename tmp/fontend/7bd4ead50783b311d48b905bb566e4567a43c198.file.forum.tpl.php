<?php /* Smarty version Smarty-3.1.16, created on 2015-01-01 06:24:44
         compiled from "C:\xampp\htdocs\Jiggasa\template\fontend\forum.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3155054a4d73db61575-65788565%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7bd4ead50783b311d48b905bb566e4567a43c198' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Jiggasa\\template\\fontend\\forum.tpl',
      1 => 1420089882,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3155054a4d73db61575-65788565',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_54a4d73dd58071_01164971',
  'variables' => 
  array (
    'register' => 0,
    'u_name' => 0,
...
<?php if ($_valid && !is_callable('content_54a4d73dd58071_01164971')) {function content_54a4d73dd58071_01164971($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_image')) include 'C:\\xampp\\htdocs\\Jiggasa\\include\\smarty\\libs\\plugins\\function.html_image.php';
if (!is_callable('smarty_modifier_date_format')) include 'C:\\xampp\\htdocs\\Jiggasa\\include\\smarty\\libs\\plugins\\modifier.date_format.php';
if (!is_callable('smarty_modifier_replace')) include 'C:\\xampp\\htdocs\\Jiggasa\\include\\smarty\\libs\\plugins\\modifier.replace.php';
if (!is_callable('smarty_modifier_capitalize')) include 'C:\\xampp\\htdocs\\Jiggasa\\include\\smarty\\libs\\plugins\\modifier.capitalize.php';
...
?>
						<a href="forum.php?uname=<?php echo mb_strtolower($_smarty_tpl->tpl_vars['info']->value['userName'], 'UTF-8');?>
...
&nbsp;
					...
					<a href="forum.php" style="font-size:12px;"><?php echo $_smarty_tpl->tpl_vars['u_name']->value;?>
</a>
...
?>
							<li>
								<a href="forum.php?uname=<?php echo mb_strtolower($_smarty_tpl->tpl_vars['question']->value['userName'], 'UTF-8');?>
...
"><?php echo $_smarty_tpl->tpl_vars['question']->value['userName'];?>
									...
									<?php if ($_smarty_tpl->tpl_vars['question']->value['userName']==$_smarty_tpl->tpl_vars['u_name']->value) {?>
										<a id="ques" href="forum.php?question=<?php echo $_smarty_tpl->tpl_vars['question']->value['q_id'];?>
...
?>
											<!-- <?php if ($_smarty_tpl->tpl_vars['question']->value['q_id']==$_smarty_tpl->tpl_vars['ans']->value['qs_id']) {?> -->
												<span class="ans">
													<a href="forum.php?uname=<?php echo mb_strtolower($_smarty_tpl->tpl_vars['ans']->value['userName'], 'UTF-8');?>
...
">
														...
														<?php if ($_smarty_tpl->tpl_vars['ans']->value['userName']==$_smarty_tpl->tpl_vars['u_name']->value) {?>
															<a href="forum.php?answer=<?php echo $_smarty_tpl->tpl_vars['ans']->value['ans_id'];?>
...
?>
							<li>
								<a href="forum.php?uname=<?php echo mb_strtolower($_smarty_tpl->tpl_vars['people']->value['userName'], 'UTF-8');?>
...
?>
							<li><a href="forum.php?uname=<?php echo mb_strtolower($_smarty_tpl->tpl_vars['myprofile']->value['userName'], 'UTF-8');?>
...
?>
							<li><a href="forum.php?uname=<?php echo mb_strtolower($_smarty_tpl->tpl_vars['o_profile']->value['userName'], 'UTF-8');?>
"><?php echo smarty_function_html_image(array('file'=>"subscribers/".((string)$_smarty_tpl->tpl_vars['o_profile']->value['userId'])."/".((string)$_smarty_tpl->tpl_vars['o_profile']->value['profile_img']),'width'=>"100px;",'height'=>"100px;",'class'=>"thumbnail"),$_smarty_tpl);?>
			...
			<div class="span3 sidebar">
				<ul class="pull-right nav nav-list">
					<li><a href="forum.php?action=myprofile">My Profile</a></li>
...
?>
						<li class="ans">
							<a href="forum.php?uname=<?php echo mb_strtolower($_smarty_tpl->tpl_vars['sidebar_ans']->value['userName'], 'UTF-8');?>
"><?php echo smarty_function_html_image(array('file'=>"subscribers/".((string)$_smarty_tpl->tpl_vars['sidebar_ans']->value['userId'])."/".((string)$_smarty_tpl->tpl_vars['sidebar_ans']->value['profile_img']),'width'=>"40px;",'height'=>"40px;"),$_smarty_tpl);?>
							...
							<div class="entry-ans"><a href="forum.php?uname=<?php echo mb_strtolower($_smarty_tpl->tpl_vars['sidebar_ans']->value['userName'], 'UTF-8');?>
